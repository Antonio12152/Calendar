<table class="w-full text-sm text-left rtl:text-right text-black dark:text-gray-400">
    <thead class="text-xs text-black uppercase bg-gray-100 dark:bg-gray-800 dark:text-gray-500">
        <tr>
            ...
            <th scope="col" class="px-16 py-3">Task Description</th>
            <th scope="col" class="px-1 py-3">Task Action</th>
        </tr>
    </thead>
    @foreach($tasks as $task)
    <tbody x-data="{show_jobs:false}">
        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
            <th x-on:click="show_jobs = !show_jobs"> {{ $task->name }}</th>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-black dark:text-gray-400">
                    <thead class="text-xs text-black uppercase bg-gray-100 dark:bg-gray-800 dark:text-gray-500">
                        <tr>
                            ...
                            <th scope="col" class="px-1 py-3">Job Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
